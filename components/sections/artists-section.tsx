    ...
    >
      <Link
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.backgroundColor = accent.borderColor.replace('0.7', '0.05')
        }}
        onMouseLeave={(e) => {
...
export function ArtistsSection({ locale, copy }: ArtistsSectionProps) {
      ...
      <AnimatedSection id="artists" className="space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-6">
          {[1, 2, 3, 4, 5, 6].map((id) => (
            ...
            >
              <Skeleton variant="shimmer" className="h-20 w-20" rounded="full" />
  ...
  return (
    <AnimatedSection id="artists" className="space-y-8 overflow-visible" scrollParallax>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <SectionHeader eyebrow={copy.eyebrow} title={copy.title} />
