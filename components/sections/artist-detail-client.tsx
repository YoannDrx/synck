    ...
    const worksCount = works.length;
      ...
      return (
        ...
        <PageLayout orbsConfig="subtle" className="mx-auto max-w-[1400px]">
              ...
              <div className="flex-1">
                ...
                {artist.bio && (
                  ...
                  >
                    ...
                    <p className="w-full text-base leading-relaxed text-white/70 whitespace-pre-line">
                ...
                >
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      "mb-2 text-xs font-bold uppercase tracking-wider text-[#d5ff0a]",
          ...
          {mounted && isImageOpen && artist.image && createPortal(
