...
const BUTTON_VARIANTS = {
  lime: cn(
    BUTTON_BASE,
    "border-4 border-lime-300 bg-gradient-to-r from-lime-300 to-emerald-400 text-[#050505]",
  ...
  outline: cn(
    ...
    "hover:border-lime-300 hover:text-lime-300 hover:shadow-[0_0_20px_rgba(213,255,10,0.3)]",
  ),
};
