...
const PDFViewerClient = dynamic(
  () => import("@react-pdf/renderer").then((mod) => mod.PDFViewer),
  {
    ssr: false,
    loading: () => (
      <div className="h-[600px] w-full flex items-center justify-center bg-white/5 text-white">
        Chargement du PDF...
      </div>
    ),
  },
...
export function CVEditor({
  ...
  const initialTheme: CVTheme = {
    ...
    ...(baseData.theme ?? {}),
    primary:
      baseData.accentColor ?? baseData.theme?.primary ?? defaultTheme.primary,
  };
      ...
      <div className="space-y-6 overflow-y-auto pr-2 h-full pb-20">
        ...
        <Card className="bg-black border-white/10">
          <CardHeader>
            <CardTitle className="text-white flex items-center gap-2">
              <SettingsIcon className="w-5 h-5" /> Paramètres Généraux
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-black border-white/10 text-white h-20"
              />
            </div>
            <div className="space-y-2">
        ...
        <Card className="bg-black border-white/10">
          ...
          <CardContent className="pt-6 space-y-4">
                    ...
                    <AccordionTrigger className="hover:no-underline py-2 text-white">
                      <div className="flex items-center gap-3">
                        <span className="text-lg font-medium">
                          {getT(section.translations, "fr").title ??
                            "Nouvelle Section"}
                        </span>
                        <span className="text-xs bg-white/10 px-2 py-1 rounded text-white/50 uppercase">
                  ...
                  <AccordionContent className="space-y-6 pb-4">
                    ...
                    <div className="space-y-4 mt-4">
                      <div className="flex items-center justify-between border-b border-white/10 pb-2">
                        ...
                        >
                          <PlusIcon className="mr-2 h-3 w-3" /> Ajouter un
                          élément
                        </Button>
                      </div>
                      ...
                      {section.items?.map((item, iIndex) => (
                        <div
                          key={iIndex}
                          className="p-4 border border-white/10 rounded-md bg-black/40 space-y-4"
                        >
                          ...
                          <Tabs defaultValue="fr" className="w-full">
                            ...
                            <TabsContent value="fr" className="space-y-3 mt-3">
                              <Input
                                ...
                                value={
                                  getT(item.translations, "fr").title ?? ""
                                }
                                onChange={(e) => {
                              ...
                              <Input
                                ...
                                value={
                                  getT(item.translations, "fr").subtitle ?? ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                                    sIndex,
                              ...
                              <Input
                                placeholder="Lieu"
                                value={
                                  getT(item.translations, "fr").location ?? ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                                    sIndex,
                              ...
                              <Textarea
                                ...
                                value={
                                  getT(item.translations, "fr").description ??
                                  ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                            ...
                            <TabsContent value="en" className="space-y-3 mt-3">
                              <Input
                                ...
                                value={
                                  getT(item.translations, "en").title ?? ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                                    sIndex,
                              ...
                              <Input
                                ...
                                value={
                                  getT(item.translations, "en").subtitle ?? ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                                    sIndex,
                              ...
                              <Input
                                ...
                                value={
                                  getT(item.translations, "en").location ?? ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
                                    sIndex,
                              ...
                              <Textarea
                                placeholder="Description"
                                value={
                                  getT(item.translations, "en").description ??
                                  ""
                                }
                                onChange={(e) => {
                                  updateItemTranslation(
            ...
            <Button
              variant="outline"
              className="w-full border-dashed border-white/20 hover:bg-white/5 text-white py-8 mt-4"
              onClick={addSection}
            >
