...
const variantStyles = {
  ...
  emerald: 'bg-gradient-to-br from-[var(--brand-emerald)] to-[var(--brand-green)]',
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col gap-4">
        <div className="text-xs tracking-[0.4em] uppercase opacity-70">{status}</div>
        <h3 className="text-2xl font-black tracking-tight uppercase">{title}</h3>
        <p className="text-sm tracking-[0.4em] uppercase">{descriptor}</p>
        <div className="mt-auto text-xs tracking-[0.4em] uppercase opacity-70">
          Scroll to engage
        </div>
      </div>
    </div>
