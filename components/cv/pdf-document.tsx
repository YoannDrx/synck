...
const HeaderShapes = ({ theme }: { theme: CVTheme }) => (
  <Svg style={styles.headerShapes} viewBox="0 0 600 190">
    ...
    <Polygon points="420,0 620,0 620,190" fill="#11131C" opacity={String(0.8)} />
    <Polygon points="520,0 620,0 620,110" fill={theme.primary} opacity={String(0.8)} />
    <Polygon points="0,140 60,190 0,190" fill={theme.primary} opacity={String(0.8)} />
    <Polygon points="140,0 340,0 240,120" fill={theme.secondary} opacity={String(0.14)} />
  </Svg>
)
